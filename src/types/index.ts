...
// The old GeminiExtraction is superseded by this version which includes
// metrics array, location recommendations, and thinking details.
export interface GeminiExtraction {
  ...
  // These are no longer primary outputs but may be present in
  // older extractions stored in Supabase.

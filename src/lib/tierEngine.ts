  ...
  switch (tier) {
    ...
    case 'exploratory':
      return {
        tier,
        llmCount: 2,
        llmModels: ['gemini-3.1-pro', 'claude-sonnet-4-6'],
        useJudge: false,
        tavilySearches: 10,
      };
    case 'filtered':
      return {
        tier,
        llmCount: 3,
        llmModels: ['gemini-3.1-pro', 'claude-sonnet-4-6', 'gpt-4o'],
        useJudge: false,
        tavilySearches: 15,
      };
    case 'evaluated':
      return {
        tier,
        llmCount: 4,
        llmModels: ['gemini-3.1-pro', 'claude-sonnet-4-6', 'gpt-4o', 'grok-4'],
        useJudge: false,
        tavilySearches: 20,
      };
    case 'validated':
      return {
        tier,
        llmCount: 5,
        llmModels: ['gemini-3.1-pro', 'claude-sonnet-4-6', 'gpt-4o', 'grok-4', 'perplexity-sonar'],
        useJudge: true,
        tavilySearches: 200,
      };
    case 'precision':

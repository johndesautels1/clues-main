...
> = {
  ...
  'gemini-3.1-pro':      { input: 1.25,  output: 10.00,  label: 'Gemini 3.1 Pro',           icon: '\u{1F48E}' },
...
export const PROVIDER_GROUPS: { key: string; label: string; icon: string; providers: CostProvider[] }[] = [
  ...
  { key: 'gemini',     label: 'Gemini 3.1 Pro (Preview)',    icon: '\u{1F48E}', providers: ['gemini-3.1-pro', 'gemini-3.1-pro-preview'] },

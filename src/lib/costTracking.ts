...
> = {
  ...
  'gemini-2.5-pro':      { input: 1.25,  output: 10.00,  label: 'Gemini 2.5 Pro',           icon: '\u{1F48E}' },
  ...
  'olivia':              { input: 3.00,  output: 15.00,  label: 'Olivia (Chat Assistant)',   icon: '\u{1F4AC}' },
...
export const PROVIDER_GROUPS: { key: string; label: string; icon: string; providers: CostProvider[] }[] = [
  ...
  { key: 'gemini',     label: 'Gemini 2.5 Pro',             icon: '\u{1F48E}', providers: ['gemini-2.5-pro'] },

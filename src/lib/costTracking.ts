...
> = {
  'claude-sonnet-4-6':   { input: 3.00,  output: 15.00,  label: 'Claude Sonnet 4.6 (Olivia)', icon: '\u{1F4AC}' },
...
export const PROVIDER_GROUPS: { key: string; label: string; icon: string; providers: CostProvider[] }[] = [
  ...
  { key: 'sonnet46',   label: 'Claude Sonnet 4.6 (Olivia)',  icon: '\u{1F4AC}', providers: ['claude-sonnet-4-6'] },

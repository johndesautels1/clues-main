...
const EVALUATOR_IDENTITY = {
  ...
  sourceInstruction: 'Attribution to a specific data source (include URLs)',
  reasoningInstruction: 'Your search-augmented reasoning chain',
  sourceSchemaExample: '<data source with URL>',
};
